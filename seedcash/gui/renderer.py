...
#from seedcash.hardware.ST7789 import ST7789
...
class Renderer(ConfigurableSingleton):
    ...
    def configure_instance(cls):
        ...
        renderer.initialize_display() # (compatibility with the merged SeedCash PR #741)


    def initialize_display(self): # (compatibility with the merged SeedCash PR #741)
